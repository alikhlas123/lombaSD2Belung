                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="aksi-kelas.php" method="post">
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" class="form-control" name="lemari">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="mejakursi">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="papan">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="pintu">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" class="form-control" name="gambar">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="jam">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="mapel">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="struktur">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="piket">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="atk">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="taplak">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="alat">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="slogan">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" class="form-control" name="mejaguru">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="mejasiswa">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="alatbersih">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <select class="form-select" class="form-control" name="dinding">
                                        <option value="">---Pilih---</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
