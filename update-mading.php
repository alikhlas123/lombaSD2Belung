    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Data Lomba Mading</h5>
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" action="aksi-mading.php">
                                                <input type="hidden" name="id_mading" value="<?php echo $data['id_mading']; ?>">
